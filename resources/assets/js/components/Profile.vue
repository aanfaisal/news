      ...
      <form role="form">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <input v-model="user.name" class="form-control" name="name" placeholder="nama">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input v-model="user.email" type="email" class="form-control" name="Email" placeholder="Masukkan email">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input v-model="user.new_password" type="password" class="form-control" name="new_password" placeholder="Password Baru">
          </div>
          <div class="form-group">
            <label for="new_password_confirmation">Konfirmasi Password:</label>
            <input v-model="user.new_password_confirmation" type="password" class="form-control" name="new_password_confirmation" placeholder="Konfirmasi Password">
          </div>
        </div>
        <!-- /.box-body -->
        <div class="box-footer">
          <button @click="updateUser(user)" class="btn btn-primary btn-lg btn-flat">Simpan</button>
        </div>
      </form>
    </div>
    <!-- /.box -->
