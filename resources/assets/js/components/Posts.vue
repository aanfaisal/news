    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Semua postingan</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body table-responsive no-padding">
          <table class="table table-hover">
            ...
            <tr v-for="post in posts">
              ...
              <td class="col-md-3">
                <div class="btn-group">
                  <a v-if="post.status == 'approved'" href="/blog/{{post.slug}}" target="blank"  class="btn btn-success" role="button">Lihat</a>
                  <button v-link="{ name: 'editpost', params: {hashid: post.hashid}}" type="button" class="btn btn-info">Edit</button>
                  <button type="button" class="btn btn-danger" @click="deletePost(post)">Hapus</button>
                </div>
              </td>
              <td>
