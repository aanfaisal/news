  ...
  <aside class="main-sidebar">
    ...
    {{creatingPost}}
      ...
      <ul class="sidebar-menu">
        <li><a v-link="{ path: '/' }"><i class="fa fa-home"></i> <span>Beranda</span></a></li>
        <!-- Optionally, you can add icons to the links -->
        <li class="treeview">
          <a href="#">
            <i class="fa fa-list"></i> <span>Posting</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a v-link="{ path: '/posts' }"><i class="fa fa-tasks"></i>Index</a></li>
            <li><a @click="createPost" href="#"><i class="fa fa-keyboard-o"></i>Buat post</a></li>
          </ul>
        </li>
        <li><a v-link="{ path: '/categories' }"><i class="fa fa-th-large"></i> <span>Kategori</span></a></li>
        <li><a v-link="{ path: '/users' }"><i class="fa fa-users"></i> <span>User Management</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
